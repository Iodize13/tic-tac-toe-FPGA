...
# set_property -dict {PACKAGE_PIN V11 IOSTANDARD LVCMOS33} [get_ports {cellTemp[0]}]
...
# Anodes (AN0 - AN7)
set_property -dict { PACKAGE_PIN J17 IOSTANDARD LVCMOS33 } [get_ports { an[0] }]; # ขวาสุด
...
set_property -dict { PACKAGE_PIN U13 IOSTANDARD LVCMOS33 } [get_ports { an[7] }]; # ซ้ายสุด
