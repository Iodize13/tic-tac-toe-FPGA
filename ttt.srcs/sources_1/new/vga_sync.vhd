...
begin
    ...
    -- Active LOW vsync: pulse at lines 490-491 (525 total lines for 640x480)
    vsync <= '0' when v_cnt >= 490 and v_cnt < 492 else '1';
    
    -- Video on during active display area (640x480)
    ...
    -- Counter control: 800x525 for 640x480 @ 60Hz
