...
begin 
    ...
    c(8) <= inPort(8) and not cellGame(16);
    c(7) <= inPort(7) and not cellGame(14);
    c(6) <= inPort(6) and not cellGame(12);
    c(5) <= inPort(5) and not cellGame(10);
    c(4) <= inPort(4) and not cellGame(8);
    c(3) <= inPort(3) and not cellGame(6);
    c(2) <= inPort(2) and not cellGame(4);
    c(1) <= inPort(1) and not cellGame(2);
    c(0) <= inPort(0) and not cellGame(0);
